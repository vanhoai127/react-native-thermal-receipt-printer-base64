...
public class NetPrinterAdapter implements PrinterAdapter {
    ...
    public static int[][] getPixelsSlowV2(Bitmap image2, int imageWidth, int imageHeight) {

        Bitmap image = resizeTheImageForPrintingV2(image2, imageWidth, imageHeight);
    ...
    public static Bitmap resizeTheImageForPrintingV2(Bitmap image, int imageWidth, int imageHeight) {
        // making logo size 150 or less pixels
        int width = image.getWidth();
        int height = image.getHeight();
        if (Integer.toString(imageWidth) != null || Integer.toString(imageHeight) != null) {
            return getBitmapResizedV2(image, 1, imageWidth, imageHeight);
        }
        if (width > 200 || height > 200) {
            ...
            return getBitmapResizedV2(image, decreaseSizeBy, 0, 0);
        }
        return image;
    }
    public static Bitmap getBitmapResizedV2(Bitmap image, float decreaseSizeBy, int imageWidth, int imageHeight) {
